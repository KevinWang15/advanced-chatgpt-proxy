...
const {startWithChrome, startWithAdsPower} = require("./services/launch_browser");
const {
    workers,
    accounts,
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            if (config.adspower) {
                ...
                throw new Error("No browser configuration found. Please set either 'chrome' or 'adspower' in the config.");
            }
        }, 1000);
    }, 1000);
} else {
